	...
	private void addListener() {
		...
		tf2.getDocument().addDocumentListener(new DocumentListener(){
			...
			public void changedUpdate(DocumentEvent arg0) {
				...
				// TODO Auto-generated method stub
				try {
					t1 = Double.parseDouble(tf1.getText());
				} catch (Exception et) {
					// TODO: handle exception
					JOptionPane.showMessageDialog(null, "输入的数字不正确", 
							"提示", JOptionPane.INFORMATION_MESSAGE);
					tf1.setText("");
					return;
				}
				double t2 = Double.parseDouble(lbE.getText());//应收金额
				double t3 = Double.parseDouble(lbF.getText());//押金
				double t4 = Double.parseDouble(lbG.getText());//优惠金额
