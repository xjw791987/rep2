...
implements ActionListener, MouseListener {
	...
	private void addListener() {
		...
		//变化监听
		rtp_tb.addChangeListener(new ChangeListener(){

			@Override
			public void stateChanged(ChangeEvent arg0) {
				// TODO Auto-generated method stub
				int index1 = rtp_tb.getSelectedIndex();
				switch (index1) {
				case 0:
					com.sunshine.individual.Individual.lbB.setText("标准单人间");
					break;
				case 1:
					com.sunshine.individual.Individual.lbB.setText("标准双人间");
					break;
				case 2:
					com.sunshine.individual.Individual.lbB.setText("豪华单人间");
					break;
				case 3:
					com.sunshine.individual.Individual.lbB.setText("豪华双人间");
					break;
				case 4:
					com.sunshine.individual.Individual.lbB.setText("商务套房");
					break;
				case 5:
					com.sunshine.individual.Individual.lbB.setText("总统套房");
					break;
				default:
					break;
				}
				com.sunshine.individual.Individual.lbB.setText("");
			}
